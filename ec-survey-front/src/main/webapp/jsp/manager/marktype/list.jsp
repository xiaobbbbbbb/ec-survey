		...
		<div class="row-fluid">
			<div>
				<ul class="breadcrumb">
					...
					<li class="active">标注类别管理</li>
				</ul>
				<div class="btn-toolbar">
					<button class="btn btn-primary" onfocus="this.blur()" onclick="href('${ctx}/markType/addUI');">添加标注类别</button>
				</div>
				<div class="well">
						...
						<tbody>
							<c:forEach items="${ECPage.list }" var="dto" varStatus="sn">
								<tr>
									<td>${sn.count}</td>
									<td>${dto.name}</td>
									<td><img alt="" src="${ctx}/media/images/mark_image/${dto.img}.png"></td>
									...
									<td class="td_center"><fmt:formatDate value="${dto.createTime}" pattern="yyyy-MM-dd HH:mm" /></td>
									<td class="td_center"><a onfocus="this.blur()" href="${ctx}/markType/updateUI?id=${dto.id}"><i
											class="icon-pencil"></i></a> <a onfocus="this.blur()" role="button" href="javascript:void(0)"
										onclick="$.ec.deleteData({url : '${ctx}/markType/delete',param : {'ids':${dto.id}}});"> <i
											class="icon-remove"></i>
									</a></td>
								</tr>
							</c:forEach>
					...
					<form action="${ctx}/markType/list" id="pageForm">
