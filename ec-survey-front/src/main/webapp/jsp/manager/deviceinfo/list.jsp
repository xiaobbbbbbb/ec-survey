			...
			<div>
				...
				<div class="btn-toolbar">
					<button class="btn btn-primary" onfocus="this.blur()"
						onclick="href('${ctx}/deviceInfo/addUI');">添加设备</button>
				...
				<div class="well">
						...
						<tbody>
							<c:forEach items="${ECPage.list }" var="dto" varStatus="sn">
								<tr>
									...
									<td class="td_center"><a href="${ctx}/deviceInfo/updateUI?id=${dto.id}"><i class="icon-pencil"></i></a> <a
										onfocus="this.blur()" role="button" href="javascript:void(0)"
										onclick="$.ec.deleteData({url : '${ctx}/deviceInfo/delete',param : {'ids':${dto.id}}});">
					...
					<form action="${ctx}/deviceInfo/list" id="pageForm">
